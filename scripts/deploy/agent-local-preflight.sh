...
dotenv_report="$(awk '
  ...
  END {
    ...
    if (("TERMFLOW_AGENT_PROVIDER_DEEPSEEK_MODEL_IDS" in values) && values["TERMFLOW_AGENT_PROVIDER_DEEPSEEK_MODEL_IDS"] != "deepseek-flash" && values["TERMFLOW_AGENT_PROVIDER_DEEPSEEK_MODEL_IDS"] != "deepseek-v4-flash")
