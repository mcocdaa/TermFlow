<template>
  <section class="dashboard-view" aria-labelledby="dashboard-title">
    <header class="page-heading"><div><p class="eyebrow">实时状态</p><h1 id="dashboard-title">控制中心</h1></div><div class="page-heading-actions"><button class="text-button" type="button" @click="refresh">刷新</button></div></header>
