import type { BrowserSessionDeleteResponse, BrowserSessionResponse } from '@termflow/client-contracts'
...
export function createSessionApi(request: ApiRequest) {
  return {
    ...
    login: (adminToken: string, signal?: AbortSignal) => request<BrowserSessionResponse>('/api/v1/admin/sessions', withSignal({
      method: 'POST',
