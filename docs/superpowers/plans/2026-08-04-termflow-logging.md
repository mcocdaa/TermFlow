...
- [x] **Step 1: Write failing path, JSON, rotation, and redaction tests**
...
- [x] **Step 3: Implement the minimal logger**
...
- [x] **Step 4: Configure the CLI and Bridge entrypoint**
...
- [x] **Step 5: Run the focused tests and the existing A suite**
...
- [x] **Step 6: Commit the A logging slice**
...
- [x] **Step 3: Implement the Rust logger and Tauri command**
...
- [x] **Step 4: Add the TypeScript diagnostics adapter and tests**
...
- [x] **Step 3: Instrument the flow with sanitized events**
...
- [x] **Step 4: Run focused tests and the full client suite**
