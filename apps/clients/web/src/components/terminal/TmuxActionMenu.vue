<template>
  <div class="tmux-controls">
    <div class="titlebar-menu desktop-action-menu" @mouseenter="preview = true" @mouseleave="preview = false">
      <button ref="desktopTrigger" data-action="toggle-tmux-menu" class="titlebar-button" type="button" aria-haspopup="menu" :aria-expanded="menuOpen" @click="pinned = !pinned">Tmux 操作 <span aria-hidden="true">▾</span></button>
