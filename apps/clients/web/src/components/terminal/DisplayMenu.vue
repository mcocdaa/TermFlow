<template>
  <div class="titlebar-menu">
    <button ref="trigger" data-action="toggle-display-menu" class="titlebar-button" :class="{ 'is-open': open }" type="button" aria-haspopup="menu" :aria-expanded="open" @click="toggleMenu"><MonitorCog :size="16" aria-hidden="true" /><span>显示</span><ChevronDown class="menu-chevron" :size="15" aria-hidden="true" /></button>
