<template>
  <header class="terminal-titlebar">
    ...
    <div class="terminal-titlebar-actions">
      <DisplayMenu :model-value="displayMode" :open="displayMenuOpen" @update:model-value="$emit('update:displayMode', $event)" @update:open="$emit('update:displayMenuOpen', $event)" />
      <slot />
      <button
