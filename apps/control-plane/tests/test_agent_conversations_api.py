...
from termflow_control_plane.api.agent_conversations import AgentSubmitMessageRequest
...
def test_submit_request_contract_has_no_transcription_reference() -> None:
